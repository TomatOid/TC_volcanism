...
% Display doc button on graphs for accessing descriptions of graphs
    Docdisp='y';            % 'y' |   -   | Set to 'y' to display doc access button on graphs
% Units for display
    runits='mm';      %    'mm'   |   -   | Rain depth units: inches ('in') or millimeters ('mm')
...
% Histograms and return period plots 
    ...
    vbeg=96;          %     40    | knots | Lowest wind speed for histograms (this will be converted into desired units automatically)
    ...
    hbins='norm';     %   'norm'  |   -   | Regular bins ('norm') or Saffir-Simpson ('ss')
...
% Track plot parameters
    ...
    cplot='y';        %     'y'   |   -   | Include colorbar for intensity scale? ('y' or 'n')
...
% Genesis, track density, and power dissipation density plot parameters
    ...
    gres=1;           %      4    |degrees| Resolution of genesis density map
    gresbest=1;       %      6    |degrees| Resolution of best track genesis density maps
    mres=0.5;           %      4    |degrees| Resolution of track and power dissipation density maps
    mresbest=0.25;       %      4    |degrees| Resolution of best track density maps
...
% Parameters used by m_map and/or Matlab Mapping Toolbox
    ...
    latmin=-60;       %     -     |degrees| Lower bound on latitude plotted ('manu' mode only, -90 to 90)    
    latmax=80;        %     -     |degrees| Upper bound on latitude plotted ('manu' mode only, -90 to 90)    
